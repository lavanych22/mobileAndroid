package com.dovhan.mobileapp.main_group.car;
...
public class AddCarFragment extends Fragment {
    ...
    private boolean areFieldsValid(final String name, final String registrationNumber,
        ...
        if (TextUtils.isEmpty(registrationNumber)) {
            registrationNumberEt.setError(context.getString(R.string.invalid_field));
        }
        ...
        if (TextUtils.isEmpty(colour)) {
            colourEt.setError(context.getString(R.string.invalid_field));
        }
